from genutility.args import in_range, positive_float
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=in_range(1, 65536), default=DEFAULT_PORT, help="Aria2 RPC port")
    ...
    parser.add_argument("--poll", type=positive_float, default=5.0, help="Refresh progress every x seconds")
