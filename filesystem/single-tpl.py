...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
        description="""Create a file based on a template for file in directory.
...
For example this can be used to create a shell script to include multiple video encode commands."""
    ...
    prepend_group.add_argument(
        "--prepend",
        default="",
        help="String to prepend to the output file once. Use {num} to include number of entries.",
    )
    prepend_group.add_argument(
        "--prependfile",
        type=is_file,
        help="File to prepend to the output file once. Use {num} to include number of entries.",
    )
