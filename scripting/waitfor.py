...
if __name__ == "__main__":
	...
	parser.add_argument("--max-tries", metavar="N", type=int, default=None, help="Specifies the maximum number of attempts. Infinite if not given.")
	parser.add_argument("--status-codes", metavar="N", nargs="+", type=int, default=set(), help="Acceptable HTTP status codes. If not specified all status codes are accepted.")
